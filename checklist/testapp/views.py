...
from testapp.serializers import SecuredListSeralizer
...
class SecuredListsAPIView(ListCreateAPIView):
    """
    Listing, Creation
    """
    ## converting into genric view.
    serializer_class = SecuredListSeralizer
    permission_classes = [IsAuthenticated, IsOwner]

    def get_queryset(self):
        queryset = SecuredList.objects.filter(user=self.request.user)
        return queryset
